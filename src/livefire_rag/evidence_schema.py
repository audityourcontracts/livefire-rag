...
GENERIC_EVIDENCE_SCHEMA_NAMES = (
    "corpus-census.v1.schema.json",
    "benchmark-selection-manifest.v1.schema.json",
    "benchmark-selection-row.v1.schema.json",
    "tokenizer-parity-fixture.v1.schema.json",
    "dataset-catalogue.v1.schema.json",
    ...
    "runpod-storage-challenge-failure.v1.schema.json",
